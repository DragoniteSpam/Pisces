...
public class PauseScreenMovesSkillsMoves implements PauseScreenDrawable {
	...
	public PauseScreenMovesSkillsMoves(Texture overlayTexture, int iconX, int iconY, int selectedIconX, int selectedIconY, int grayedIconX, int grayedIconY, String name) {
