...
public class PauseScreenQuitWindows implements PauseScreenDrawable {
	...
	public PauseScreenQuitWindows(Texture overlayTexture, int iconX, int iconY, int selectedIconX, int selectedIconY, int grayedIconX, int grayedIconY, String name) {
