...
public class PauseScreenMap implements PauseScreenDrawable {
	...
	public PauseScreenMap(Texture overlayTexture, int iconX, int iconY, int selectedIconX, int selectedIconY, int grayedIconX, int grayedIconY, String name) {
