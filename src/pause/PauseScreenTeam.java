...
public class PauseScreenTeam implements PauseScreenDrawable {
	...
	public PauseScreenTeam(Texture overlayTexture, int iconX, int iconY, int selectedIconX, int selectedIconY, int grayedIconX, int grayedIconY, String name) {
