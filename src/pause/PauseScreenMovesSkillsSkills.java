...
public class PauseScreenMovesSkillsSkills implements PauseScreenDrawable {
	...
	public PauseScreenMovesSkillsSkills(Texture overlayTexture, int iconX, int iconY, int selectedIconX, int selectedIconY, int grayedIconX, int grayedIconY, String name) {
