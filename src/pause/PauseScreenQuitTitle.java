...
public class PauseScreenQuitTitle implements PauseScreenDrawable {
	...
	public PauseScreenQuitTitle(Texture overlayTexture, int iconX, int iconY, int selectedIconX, int selectedIconY, int grayedIconX, int grayedIconY, String name) {
