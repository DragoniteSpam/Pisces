...
public class PauseScreenStuff implements PauseScreenDrawable {
	...
	public PauseScreenStuff(Texture overlayTexture, int iconX, int iconY, int selectedIconX, int selectedIconY, int grayedIconX, int grayedIconY, String name) {
